package com.user.simplemvvmexample.dagger_mvvm;
...
public class DaggerMvvmMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model.getHeroes().observe(this, new Observer<List<Hero>>() {
            ...
            public void onChanged(@Nullable List<Hero> heroList) {
                adapter = new HeroesAdapter(DaggerMvvmMainActivity.this, heroList);
